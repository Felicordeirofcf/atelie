...
export default function WhatsAppButton() {
  const phone = '5521986721761'; // troque pelo número real
  ...
  return (
    ...
    >
      <span className="mr-3 hidden rounded-full bg-white/95 px-4 py-2 text-sm font-semibold text-[#333333] shadow-lg backdrop-blur md:inline-flex">
        Fale conosco
      </span>
